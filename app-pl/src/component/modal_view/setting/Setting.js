		...
		<div className='con-mod'>
			...
			<div className='pro-p-setting__group'>
				...
				<button className='button__module pro-p-setting__group-item'>
					<Link to='personal' style={{ color: 'white' }}>
				...
				<button className='button__module pro-p-setting__group-item'>
					<span className='btn-mod-item-content'>
						<span className='btn-mod-item-content__icon'>
							<svg
								...
								<path
									fillRule='evenodd'
									clipRule='evenodd'
									d='M18 2h-3v1a1 1 0 01-1 1h-4a1 1 0 01-1-1V2H6v20h12V2zM6 0a2 2 0 00-2 2v20a2 2 0 002 2h12a2 2 0 002-2V2a2 2 0 00-2-2H6zm6 18a1 1 0 100 2 1 1 0 000-2z'
						...
						<span className='porsonal_content'>
							...
							<span className='personal_data'>
								Подключите дополнительные меры безопасности
							</span>
						</span>
						<span className='btn-mod-item-content__icon'>
							<svg
								className='setting_icon warning'
								width='24px'
								height='24px'
								viewBox='0 0 24 24'
								role='presentation'
						...
						<span className='btn-mod-item-content__icon'>
							<svg
								...
								<path
									fillRule='evenodd'
									clipRule='evenodd'
									d='M16 9V6a4 4 0 10-8 0v3h8zM6 6v3H5a2 2 0 00-2 2v10a2 2 0 002 2h14a2 2 0 002-2V11a2 2 0 00-2-2h-1V6A6 6 0 006 6zm-1 5h14v10H5V11zm8 7v-4h-2v4h2z'
									fill='currentColor'></path>
							</svg>
						</span>
						<span className='porsonal_content'>
							<span>Пароль</span>
							<span className='personal_data'>
								Сохраните вашу учётную запись в безопасности
							</span>
						</span>
					</span>
				</button>
			...
			<div className='pro-p-setting__group'>
				...
				<button
					className='button__module pro-p-setting__group-item'
					id='popup-appearance'>
					<span className='btn-mod-item-content'>
						<span className='btn-mod-item-content__icon'>
							<svg
						...
						<span className='btn-mod-item-content__icon'>
							<svg
								...
								<path
									fill='currentColor'
									fillRule='evenodd'
									d='M14.842 8.058l-1.845 5.774a1.2 1.2 0 01-1.143.835H8.507L6.972 18.27a1.2 1.2 0 01-1.104.73H3a1 1 0 110-2h2.34l1.534-3.604a1.2 1.2 0 011.104-.73h3.292l2.37-7.42c.348-1.085 1.87-1.121 2.268-.054l2.786 7.475H21a1 1 0 110 2h-2.861a1.2 1.2 0 01-1.124-.781l-2.173-5.828z'
									clipRule='evenodd'></path>
							</svg>
						</span>
						<span className='porsonal_content'>
						...
						<span className='btn-mod-item-content__icon'>
							<svg
								...
								<path
									fill='currentColor'
									fillRule='evenodd'
									d='M5.217 8.358a6.797 6.797 0 0113.566 0L19.277 16H20a1 1 0 110 2h-4a4 4 0 01-8 0H4a1 1 0 110-2h.722l.495-7.642zM6.727 16h10.546l-.486-7.512a4.797 4.797 0 00-9.575 0L6.726 16zM14 18h-4a2 2 0 104 0z'
									clipRule='evenodd'></path>
							</svg>
						</span>
						<span className='porsonal_content'>
							...
							<span className='personal_data'>
								Специальные акции, уведомления для игр и
								push-уведомления
							</span>
						</span>
					</span>
