            ...
            <div className="con-mod popup-setting">
                ...
                <div className="pro-p-setting__group">
                    ...
                    <button className="button__module pro-p-setting__group-item">
                        ...
                        <svg className='pro-c-status_failed' width="24px" height="24px" viewBox="0 0 24 24" role="presentation" focusable="false" aria-hidden="true">
                    ...
                    <button className="button__module pro-p-setting__group-item">
                        <span className="btn-mod-item-content">
                            <span className='pro_settings_name'>Номер телефона</span>
                        </span>
                        <svg className='pro-c-status_failed' width="24px" height="24px" viewBox="0 0 24 24" role="presentation" focusable="false" aria-hidden="true">
                            <path fill="currentColor" fillRule="evenodd" d="M12 4a8 8 0 100 16 8 8 0 000-16zM2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12z" clipRule="evenodd"></path>
                            <path fill="currentColor" d="M11 16a1 1 0 111.998 0A1 1 0 0111 16z"></path>
                ...
                <div className="pro-p-setting__group">
                    ...
                    <div className="pro-p-root__setting">
                        <button className="button__module btn__pro button__setting -open">
                            <span className="itemStartIcon">
                                <svg width="24px" height="24px" viewBox="0 0 24 24" role="presentation" focusable="false" aria-hidden="true">
                                    <path fill="#FBBB00" d="M5.876 14.295l-.766 2.859-2.799.059A10.952 10.952 0 011 12c0-1.824.444-3.545 1.23-5.059l2.492.457 1.092 2.476a6.54 6.54 0 00.06 4.421h.002z"></path>
                                    <path fill="#518EF8" d="M22.807 9.945a10.998 10.998 0 01-3.922 10.633l-3.138-.16-.444-2.774a6.556 6.556 0 002.82-3.347h-5.881v-4.35h10.565v-.002z"></path>
                                    <path fill="#28B446" d="M18.885 20.578A10.951 10.951 0 0112 23a10.996 10.996 0 01-9.687-5.787l3.563-2.918a6.54 6.54 0 009.426 3.35l3.583 2.933z"></path>
                                    <path fill="#F14336" d="M19.02 3.532L15.458 6.45a6.541 6.541 0 00-9.64 3.423L2.232 6.94A10.997 10.997 0 0112 1c2.669 0 5.116.95 7.02 2.532z"></path>
                                </svg>
                            </span>
