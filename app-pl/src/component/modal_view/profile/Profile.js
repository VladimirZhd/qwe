...
const Profile = () => {
	return (
		<div className='con-mod popup-profile'>
					...
					<div className='pro-p-root__group-item__card mr1-6'>
						<span className='text__card'>
							<svg
								...
								focusable='false'
								aria-hidden='true'
								data-test='pro-p-root-c-tasks-icon'>
								<path
									fill='currentColor'
									fillRule='evenodd'
									d='M2 5a2 2 0 012-2h13.118a1 1 0 110 2H4v14h14v-5.059a1 1 0 112 0V19a2 2 0 01-2 2H4a2 2 0 01-2-2V5zm19.293-.707a1 1 0 111.414 1.414L12.561 15.854a1.5 1.5 0 01-2.122 0l-4.146-4.147a1 1 0 111.414-1.414l3.793 3.793 9.793-9.793z'
									clipRule='evenodd'></path>
							</svg>
						</span>
					...
					<div className='pro-p-root__group-item__card'>
						<span className='text__card'>
							<svg
								...
								focusable='false'
								aria-hidden='true'
								data-test='pro-p-root-c-achievements-icon'>
								<path
									fill='currentColor'
									fillRule='evenodd'
									d='M5 5a2 2 0 012-2h10a2 2 0 012 2v15a1 1 0 01-1.606.795L12 16.685l-5.394 4.11A1 1 0 015 20V5zm12 0H7v12.98l4.394-3.347a1 1 0 011.212 0L17 17.981V5z'
									clipRule='evenodd'></path>
							</svg>
						</span>
						<span></span>
			...
			<div>
				<div className='pro-p-root__setting'>
					<button
						className='button__module btn__pro button__setting -open'
						name='settings'>
						...
						<span className='itemStartIcon'>
							<svg
								...
								<path
									fill='currentColor'
									fillRule='evenodd'
									d='M5 5a2 2 0 012-2h9a2 2 0 012 2v1.667a1 1 0 11-2 0V5H7v14h9v-1.667a1 1 0 112 0V19a2 2 0 01-2 2H7a2 2 0 01-2-2V5zm14.48 3.273a1 1 0 011.413.04l2.834 3a1 1 0 010 1.374l-2.834 3a1 1 0 11-1.454-1.374L20.68 13H14a1 1 0 110-2h6.68l-1.24-1.313a1 1 0 01.04-1.414z'
									clipRule='evenodd'></path>
							</svg>
						</span>
