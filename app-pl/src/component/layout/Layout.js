...
const Layout = ({ openContainer, modal }) => {
	return (
		<div className='layout'>
			<div className='layout__aside-container'>
				<div className='sidebar-menu-vertical__body'>
					<a href='/' className='sidebar-menu-vertical__logo'>
						<div className='sidebar-menu-vertical__logo'>logo</div>
					</a>
						...
						<span className='sidebar-menu-vertical__icon'>
							<svg
								...
								<path
									fill='currentColor'
									fillRule='evenodd'
									d='M6.756 3H12a1 1 0 011 1v5.308a1 1 0 11-2 0V6.414l-6.293 6.293a1 1 0 01-1.414-1.414L9.586 5h-2.83a1 1 0 010-2zm13.951 8.293a1 1 0 010 1.414L14.414 19h2.83a1 1 0 110 2H12a1 1 0 01-1-1v-5.308a1 1 0 012 0v2.894l6.293-6.293a1 1 0 011.414 0z'
									clipRule='evenodd'></path>
							</svg>
						</span>
						<span className='sidebar-menu-vertical__title'>
							History
						</span>
					</div>
					<div className='sidebar-menu-vartical__list'>
						...
						<span className='sidebar-menu-vertical__icon'>
							<svg
								...
								<path
									fill='currentColor'
									fillRule='{evenodd}'
									d='M12 4a8 8 0 100 16h6.94l-.47-2.394a1.2 1.2 0 01.114-.788c.144-.275.627-1.217.816-1.768.242-.704.6-2.025.6-3.05a8 8 0 00-8-8zM2 12C2 6.477 6.477 2 12 2s10 4.477 10 10c0 1.362-.446 2.935-.708 3.7-.196.57-.588 1.366-.806 1.794l.605 3.075A1.2 1.2 0 0119.913 22H12C6.477 22 2 17.523 2 12z'
									clipRule='evenodd'></path>
								<path
									fill='currentColor'
									fillRule='{evenodd}'
									d='M12.127 9.013c-.662 0-1.197.535-1.197 1.196a1 1 0 01-2 0 3.197 3.197 0 115.427 2.29l-1.681 1.681a1 1 0 01-1.414-1.414l1.691-1.691.006-.006a1.197 1.197 0 00-.833-2.056z'
									clipRule='evenodd'></path>
								<path
									fill='currentColor'
									d='M13 16.559a1 1 0 11-2 0 1 1 0 012 0z'></path>
							</svg>
						</span>
						<span className='sidebar-menu-vertical__title'>
							Help
			...
			<Content openContainer={openContainer} />
		</div>
	);
};
